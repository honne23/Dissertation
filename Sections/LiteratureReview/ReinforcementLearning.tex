...
as a quantile function, is $F^{-1}(x)$. The \emph{Wasserstein} distance
...
\end{equation}
\cite{Dabney2017} results show that learners that incorporate the distribution of returns (risk-sensitive learnings)
