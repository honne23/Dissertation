...
\begin{equation}
    \begin{gathered}
        ...
        \nabla_\theta E = \sum_{j=1}^N w_j \delta_j \nabla_\theta Q(S_{j-1}, A_{j-1}\:; \: \theta)
    \end{gathered}
\end{equation}
...
subtracting results until you arrive at a leaf. Observe that the leaves of the tree are ordered, enabling
this speed up in traversal.
